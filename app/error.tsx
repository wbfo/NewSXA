...
export default function GlobalError({
  ...
  return (
    <div style={{ margin: 0, background: "#040404", color: "#d0c8b8", fontFamily: "monospace", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", width: "100vw" }}>
      <div style={{ maxWidth: 520, padding: "32px 24px", border: "1px solid #141414", background: "#0a0a0a", width: "100%", boxSizing: "border-box" }}>
