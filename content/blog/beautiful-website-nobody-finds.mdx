...
tag: "All Industries"
heroImage: "/images/blog/post-beautiful-website-nobody-finds-hero.png"
ogImage: "/images/blog/post-beautiful-website-nobody-finds-og.png"
---
...
<ActionChecklist 
  thisWeek='["Search your business on Google in an incognito window. Note your actual ranking — not the one your browser shows based on your history.", "Open ChatGPT and Perplexity. Search what a new customer would search. Document whether you appear.", "Check your website's mobile load time using Google PageSpeed Insights."]'
  thisMonth='["Commission a digital audit that goes beyond design — one that scores your technical infrastructure, local SEO, and AI visibility.", "Do not invest more in advertising until the foundation is confirmed to be working."]'
/>
