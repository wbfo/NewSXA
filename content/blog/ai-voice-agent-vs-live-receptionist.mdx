...
<ActionChecklist 
  thisWeek={["Run a call audit: how many calls did you miss last week? What percentage were after-hours? What percentage were routine inquiries an AI could have handled?", "Check whether your GBP hours, services, and contact information are accurate and current — this is the baseline requirement for any answering system to work correctly."]}
  thisMonth={["If considering an AI voice agent, commission a digital audit that includes voice compatibility assessment: schema markup, booking system integration readiness, and structured FAQ availability.", "Evaluate whether your current missed call volume justifies the cost difference. At $126,000 in average annual lost revenue from missed calls, the ROI threshold for AI answering is typically a matter of weeks."]}
/>
